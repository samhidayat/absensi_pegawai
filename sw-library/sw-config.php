...
// -------------- Koneksi Database ------------
$DB_HOST 	= 'localhost';
$DB_USER 	= 'u1718936_kia2'; // User Database
$DB_PASSWD  = 'alya04052007'; // Password Database
$DB_NAME 	= 'u1718936_kia1'; // Nama database
// -------------- Koneksi Database ------------
...
if (!function_exists('base_url')) {
	...
	else $base_url = 'https://pendma.space/absensi/';
		if ($parse) {

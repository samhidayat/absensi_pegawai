         ...
         <tr style="background:'.$background.';color:'.$warna.'">
              ...
              if($row_absen['time_in'] ==''){
                ...
                <td class="text-center picture">';
                  if($row_absen['picture_in'] ==NULL){
                    ...
                    echo'
                      <a class="image-link" href="'.$site_url.'/sw-content/present/'.$row_absen['picture_in'].'" target="_blank">
                        <img src="../timthumb?src='.$site_url.'/sw-content/present/'.$row_absen['picture_in'].'&h=40&w=40"></a>';}
                    echo'</td>
               ...
               echo'
                <td class="text-center picture">';
                  if($row_absen['picture_out'] ==NULL){
                    ...
                    echo'
                      <a class="image-link" href="'.$site_url.'/sw-content/present/'.$row_absen['picture_in'].'" target="_blank">
                        <img src="../timthumb?src='.$site_url.'/sw-content/present/'.$row_absen['picture_out'].'&h=40&w=40"></a>';}
                    echo'</td>
            ...
            <td class="text-center picture">';
              if($row_absen['picture_out'] ==NULL){
                ...
                echo'
                  <a class="image-link" href="'.$site_url.'/sw-content/present/'.$row_absen['picture_out'].'" target="_blank">
                    <img src="../timthumb?src='.$site_url.'/sw-content/present/'.$row_absen['picture_out'].'&h=40&w=40"></a>';}
            echo'</td>
            <td>'.$row_absen['time_out'].'</td>';
            }
